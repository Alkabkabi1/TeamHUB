...
<AccordionPrimitive.Header {level} class="flex">
	...
	>
		{@render children?.()}
		<HugeiconsIcon strokeWidth={2} icon={ArrowDown01Icon} data-slot="accordion-trigger-icon" class="cn-accordion-trigger-icon pointer-events-none shrink-0 group-aria-expanded/accordion-trigger:hidden" />
		<HugeiconsIcon strokeWidth={2} icon={ArrowUp01Icon} data-slot="accordion-trigger-icon" class="cn-accordion-trigger-icon pointer-events-none hidden shrink-0 group-aria-expanded/accordion-trigger:inline" />
	</AccordionPrimitive.Trigger>
