...
>
	{@render children?.()}
	<HugeiconsIcon strokeWidth={2} icon={Tick01Icon} class="cn-command-item-indicator ms-auto opacity-0 group-has-[[data-slot=command-shortcut]]/command-item:hidden group-data-[checked=true]/command-item:opacity-100" />
</CommandPrimitive.Item>
