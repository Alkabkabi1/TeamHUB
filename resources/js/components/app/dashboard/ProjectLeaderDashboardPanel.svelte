...
<section class="space-y-6">
    <div>
        <h2 class="text-lg font-bold" style="color: var(--th-text)">
            {t('dashboard.leader.title')}
        </h2>
        <p class="text-sm" style="color: var(--th-text-muted)">
            {t('dashboard.leader.subtitle')}
        </p>
    </div>
    ...
    {#if project}
        {#if projects.length > 1}
            <label class="block max-w-md space-y-1 text-sm">
                <span style="color: var(--th-text-muted)">
                    {t('dashboard.leader.select_project')}
                </span>
                <select
        ...
        <div class="grid gap-6 lg:grid-cols-2">
            <div class="th-card rounded-2xl p-4">
                ...
                >
                    {t('dashboard.leader.team_progress')}
                </h3>
                <div class="space-y-3">
            ...
            <div class="th-card rounded-2xl p-4">
                <h3
                    ...
                    style="color: var(--th-text)"
                >
                    {t('dashboard.leader.review_queue')}
                </h3>
                <div class="space-y-3">
                    {#each reviewQueue as task (task.id)}
                        ...
                        >
                            ...
                            <div class="mt-2 flex flex-wrap items-center gap-2">
                                ...
                                >
                                    {t('dashboard.leader.view_deliverable')}
                                </Link>
                                <button
                                    type="button"
        ...
        >
            <p
                ...
                style="color: var(--th-text)"
            >
                {t('dashboard.leader.assign_task')}
            </p>
            <input
                type="text"
                bind:value={taskForm.title}
                placeholder={t('dashboard.leader.task_title')}
            ...
            >
                {t('dashboard.leader.create_task')}
            </button>
        </form>
    {/if}
</section>
