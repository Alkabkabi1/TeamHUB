<script lang="ts">
    ...
    import type { DashboardKpi } from '@/types/app-dashboard';

    let { kpi }: { kpi: DashboardKpi } = $props();

    const icons: Record<DashboardKpi['icon'], IconSvgElement> = {
    ...
    const iconColors: Record<DashboardKpi['icon'], string> = {
