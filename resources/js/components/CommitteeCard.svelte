<script lang="ts">
    /**
     * Committee preview card (image, member-count meta, name, description and a
     * "view committee" CTA). Shared by the committees listing grid. The whole
     * card links to the committee page; the button repeats the action, matching
     * the Figma committee-list card.
     */
