<script lang="ts">
    ...
    let {
        ...
        club: ClubBranding & { university?: string | null };
        capabilities?: string[];
...
<AppHead title={`${club.name} — ${t('app.manage_members')}`} />
...
<div class="flex flex-1 flex-col bg-[#fdfdfd]">
    ...
    >
        <WorkspaceManageShell active="members" {club} />
        ...
        <div class="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,2fr)]">
            <DashboardCard class="flex flex-col gap-4">
                <div class="space-y-1 text-start">
                    ...
                    <p class="text-sm text-[#7e7e7e]">{club.name}</p>
                </div>

                {#if pendingApplications.length === 0}
                    <EmptyState
                        title={t('committees.dashboard.no_requests')}
                        description=""
                    />
                {:else}
                    <div class="space-y-3">
            ...
            <DashboardCard class="flex flex-col gap-4">
                ...
                {#if members.length === 0}
                    <EmptyState
                        title={t('committees.dashboard.no_members')}
                        description=""
                    />
                {:else}
                    <div class="space-y-3">
