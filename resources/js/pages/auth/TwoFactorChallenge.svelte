    ...
    const authConfigContent: TwoFactorConfigContent = $derived.by(() => {
        if (showRecoveryInput) {
            return {
                ...
                description: t('auth.use_authentication_code'),
                buttonText: t('auth.use_authentication_code'),
            };
        }

        return {
            title: t('auth.authentication_code'),
            description: t('auth.use_recovery_code'),
...
<AppHead title={t('auth.two_factor_title')} />
