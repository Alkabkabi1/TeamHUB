...
<AppHead title={`${project.name} — ${t('app.updates')}`} />
...
<div class="flex flex-1 flex-col bg-[#fdfdfd]">
    ...
    >
        <ProjectManageShell active="updates" {workspace} {project} />
        ...
        >
            ...
            {#if canManageUpdates}
                <Link
                    href={`/workspaces/${workspace.id}/projects/${project.id}/updates/create`}
                            ...
                            >
                                ...
                                {#if canManageUpdates}
                                    <div class="flex flex-wrap gap-2">
                                        <Link
                                            href={`/workspaces/${workspace.id}/projects/${project.id}/updates/${update.id}/edit`}
