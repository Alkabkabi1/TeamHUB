...
return [
    ...
    'notification' => [
        'approved' => [
            ...
            'body' => 'تمت الموافقة على طلب انضمامك إلى ":workspace". أنت الآن عضو ويمكنك المشاركة في فعاليات النادي وأنشطته.',
            'action' => 'زيارة النادي',
        ...
        'rejected' => [
            ...
            'body' => 'نعتذر، لم تتم الموافقة على طلب انضمامك إلى ":workspace" هذه المرة. يمكنك استكشاف أندية أخرى أو التقديم مرة أخرى لاحقاً.',
            'action' => 'تصفّح الأندية',
            'footer' => 'شكراً لاهتمامك بمنصة TeamHUB.',
        ],
        'received' => [
            'subject' => 'طلب عضوية جديد لنادي :workspace',
            'greeting' => 'مرحباً :name،',
            'body' => 'تقدّم :applicant بطلب للانضمام إلى ":workspace". يرجى مراجعة الطلب عندما يتاح لك ذلك.',
            'action' => 'مراجعة الطلب',
            'footer' => 'تصلك هذه الرسالة لأنك تدير أعضاء نادي :workspace.',
        ],
    ],
];
