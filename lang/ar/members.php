...
return [
    'added' => 'تمت إضافة العضو إلى مساحة العمل.',
    'removed' => 'تمت إزالة العضو من مساحة العمل.',
    'roles_updated' => 'تم تحديث أدوار العضو.',
    'last_lead' => 'يجب أن تبقى لمساحة العمل قائد واحد على الأقل.',
    ...
    'empty_hint' => 'أضف أول عضو لمساحة العمل للبدء.',
    'no_pending' => 'لا توجد طلبات معلقة.',
    'confirm_remove' => 'إزالة هذا العضو من مساحة العمل؟',
];
